    ...
    <div className="min-h-screen flex flex-col font-sans bg-white dark:bg-zinc-950">
        ...
        <div className="hidden md:flex items-center justify-center bg-zinc-50 dark:bg-zinc-900 border-l border-zinc-100 dark:border-zinc-800 p-10">
          <div className="w-full max-w-xs rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-950 overflow-hidden">
            ...
            {[
              ...
              <div
                key={r.ship}
                className="flex items-center justify-between px-4 py-3 border-b border-zinc-100 dark:border-zinc-800 last:border-none"
              >
                <div>
                ...
                <span
                  className={`text-xs px-2 py-1 rounded-full font-medium ${r.cls}`}
                >
                  {r.level}
                </span>
              </div>
      ...
      <section className="grid grid-cols-3 border-b border-zinc-100 dark:border-zinc-800">
        {[
          ...
          <div
            key={i}
            className="px-10 py-8 border-r border-zinc-100 dark:border-zinc-800 last:border-none"
          >
        ...
        {[
          {
            ...
            desc: "Track risks across every vessel with a unified register and real-time status updates.",
          },
          {
            icon: "🔍",
            title: "Advanced filtering",
            desc: "Filter by date, severity, ship, route and more. Find exactly what you need instantly.",
          },
          {
            icon: "🛡️",
          ...
          <div
            ...
            className="px-10 py-8 border-r border-zinc-100 dark:border-zinc-800 last:border-none"
          >
            <div className="w-9 h-9 rounded-lg bg-[#E1F5EE] flex items-center justify-center text-lg mb-4">
              {f.icon}
            </div>
      ...
      <section className="flex items-center justify-between flex-wrap gap-4 px-10 py-5 bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-100 dark:border-zinc-800">
        ...
        <div className="flex gap-2 flex-wrap">
          {[
            ...
            <span
              key={r.label}
              className="flex items-center gap-2 text-xs px-3 py-1.5 rounded-full border border-zinc-200 dark:border-zinc-700 text-zinc-500"
            >
              <span
      ...
      <section className="flex items-center justify-between flex-wrap gap-4 px-10 py-10">
        <div>
          ...
          <p className="text-sm text-zinc-400 mt-1">
            Sign in to access your dashboard or contact your administrator for
            access.
          </p>
        </div>
        <Link
