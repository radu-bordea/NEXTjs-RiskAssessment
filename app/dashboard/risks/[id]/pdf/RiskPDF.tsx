    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <View style={[styles.stateBadge, { backgroundColor: stateColors.bg }]}>
            <Text style={{ color: stateColors.text, fontSize: 8, fontFamily: "Helvetica-Bold" }}>
              {risk.state}
            </Text>
          </View>
        </View>
          ...
          <View style={styles.sectionBody}>
            ...
            {risk.workActivity && (
              <View style={{ marginTop: 6 }}>
                <Text style={styles.fieldLabel}>Work Activity Being Assessed</Text>
        ...
        {risk.assessmentRows?.length > 0 && (
          <View style={styles.section}>
            ...
            <View style={styles.tableHeader}>
              <Text style={[styles.tableHeaderCell, styles.colHazard]}>Hazard</Text>
              <Text style={[styles.tableHeaderCell, styles.colImpact]}>Impact</Text>
              <Text style={[styles.tableHeaderCell, styles.colControls]}>Existing Controls</Text>
              ...
              <Text style={[styles.tableHeaderCell, styles.colMeasures]}>Measures</Text>
            </View>
            ...
            {risk.assessmentRows.map((row: any, index: number) => {
              ...
              return (
                ...
                >
                  <Text style={[styles.tableCell, styles.colHazard]}>{row.hazard}</Text>
                  <Text style={[styles.tableCell, styles.colImpact]}>{row.impact}</Text>
                  <Text style={[styles.tableCell, styles.colControls]}>{row.existingControls ?? "—"}</Text>
                  <Text style={[styles.tableCell, styles.colSct]}>{row.sct ?? "—"}</Text>
                  <Text style={[styles.tableCell, styles.colC]}>{row.c ?? "—"}</Text>
                  <Text style={[styles.tableCell, styles.colF]}>{row.f ?? "—"}</Text>

                  {/* RF Badge */}
                  <View style={[styles.colRf, { alignItems: "center" }]}>
                    <View style={[styles.rfBadge, { backgroundColor: rfColors.bg }]}>
                      ...
                      return (
                        <View key={m.id} style={styles.measure}>
                          ...
                          <View style={styles.measureMeta}>
                            <Text style={styles.measureMetaText}>C: {m.c ?? "—"}</Text>
                            <Text style={styles.measureMetaText}>F: {m.f ?? "—"}</Text>
                            <View style={[styles.rfBadge, { backgroundColor: mRfColors.bg }]}>
                              <Text style={{ color: mRfColors.text, fontSize: 6 }}>
                                {m.rf ?? "—"}
                              </Text>
                            </View>
                          </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionHeaderText}>Alternative Ways to Carry Out the Work</Text>
          </View>
          <View style={styles.sectionBody}>
